...
import {
  MIRROR_RESPOND_CONTEXT,
  MIRROR_THANK_YOU_REINFORCEMENT,
} from "@/lib/copy";
...
export function RespondForm({ mtoken }: { mtoken: string }) {
    ...
    <main className="min-h-screen flex items-center justify-center px-4 py-8">
      <div className="content-container w-full max-w-[42rem]">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-sm">
            {(() => {
              const [before, ...rest] = MIRROR_RESPOND_CONTEXT.split("Mirror");
              const after = rest.join("Mirror");
              return (
                <>
                  {before}
